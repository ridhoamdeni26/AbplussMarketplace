							...
							<div class="cat_menu_container">
								...
								<ul class="cat_menu">
									...
									<li class="hassubs">
										...
										<ul>
										@php
											$subcategory = DB::table('subcategories')->where('category_id',$cat->id)->orderBy('subcategory_name','ASC')->get();
										@endphp
										@foreach($subcategory as $subcat)
											<li>
												<a href="{{ url('products/'.$subcat->id) }}">{{ $subcat->subcategory_name }}<i class="fas fa-chevron-right"></i></a>
											</li>
										@endforeach
										</ul>
									</li>
