                ...
                <div class="contact_form_container">
                    ...
                    <form method="post" action="{{ route('contact.form') }}" id="contact_form">
                        ...
                        <div class="contact_form_text">
                            <textarea id="contact_form_message" class="text_field contact_form_message" name="message_admin" rows="4" placeholder="Message" required="required" data-error="Please, write us a message."></textarea>
                        </div> 
