...
$today = DB::table('invoices')->where('date',$date)->sum('total');
...
$return = DB::table('invoices')->where('return_order',2)->sum('total');
          ...
          <div class="col-lg-6 col-6">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">{{ number_format($return) }}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
